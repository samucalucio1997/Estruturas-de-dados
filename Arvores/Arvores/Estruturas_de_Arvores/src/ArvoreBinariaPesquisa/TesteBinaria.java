...
public class TesteBinaria {
    public static void main(String[] args) {
        ...
        // No<Integer> node13 = new No<Integer>(4);
        ...
        ArvoreBinP<Integer> ar = new ArvoreBinP<>(new No<Integer>(2));
        ar.incluir(4);
        ar.incluir(3);
        // ar.incluir(8);
        // ar.incluir(2);
        ...
        // node13 = ar.incluir(node13.getValue());
        ...
        // ar.mostrar();
        // System.out.println();
        // System.out.println(ar.pesquisar(ar.getRaiz(), 14).getFather().getValue());
