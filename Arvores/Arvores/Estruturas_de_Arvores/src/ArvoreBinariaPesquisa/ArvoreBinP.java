...
public class ArvoreBinP<t> implements IArvoreBinariaPesquisa<t> {
    ...
    public ArvoreBinP(No<t> root) {
        ...
        this.comp = new Comparador<t>() {
            ...
            public int compareRN(NoRN<t> norn1, NoRN<t> norn2) {
                // TODO Auto-generated method stub
                throw new UnsupportedOperationException("Unimplemented method 'compareRN'");
            }

        };
    }

    public void incrementaElementos() {
        this.num_elem++;
    }
    ...
    public void emOrdem(No<t> no) {
        ...
        // final var paiNo =
        // Optional.ofNullable(no.getFather()).map(No::getValue).orElse(null);
    ...
    public No<t> remover(t key) {
        ...
        // else{
        // if (atual.getLeftChild() == null || atual.getRightChild() == null) {
        // No<t> filho = (atual.getLeftChild() != null) ? atual.getLeftChild() :
        // atual.getRightChild();
